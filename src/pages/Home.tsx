...
const Home = () => {
    const { scene: htmlCsene } = useGLTF("./src/assets/icons/HTML.glb");
    const { scene: cssScene } = useGLTF("./src/assets/icons/SCC.glb");
                    ...
                    <Suspense fallback="Loading...">
                        ...
                        >
                            ...
                            <group>
                                ...
                                {/* Уровень 1 — вокруг HTML */}
                                <RotatingGroup speed={0.003}>
                                    <SkillBox
                                        emmisivColor="#72118c"
                                        glow
                                        scene={cssScene}
                                    ...
                                    {/* Уровень 2 — вокруг JavaScript */}
                                    <RotatingGroup speed={0.0005}>
                                        <SkillBox
                                            scale={1}
                                            position={[-3, -3, 0]}
                                            rotation={[-0.2, 0, 0]}
...
// import { EffectComposer, Bloom } from "@react-three/postprocessing";
// import SkillBox from "./SkillBox"; // твой компонент куба
